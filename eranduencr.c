/************************************************************************/
/* eranduencr.c  Version 1.0.0                                          */
/* Encrypt an input stream with the erandu algorithm                    */
...
/**********************************************************/
/* This program initializes the erandu random number      */
...
/* Once initialized with RANDU, erandu is warmed up       */
...
int main(int argc, char **argv)
   ...
   unsigned int *statep;       /* pointer into ru->state */
   unsigned int *stateq;       /* pointer for end of ru->state */
   unsigned char psw[128];     /* password text */
   unsigned char *buf;         /* input/output buffer */
   rufmt *ru;                  /* erandu RNG structure */
   ...
   ru->prev  = RANDU;
   ru->pprev = RANDU;
   statep = (unsigned int *) ru->state;
   stateq = (unsigned int *) ru->state + 1024;
   while (statep < stateq)
      {
      *statep++ = RANDU;
      } /* for each state in ru->state array */
   /*****************************************************/
   /* warm up the erandu random number generator        */
   /*****************************************************/
   i = 2048;
   while (i--) erandu(ru);
   /*****************************************************/
