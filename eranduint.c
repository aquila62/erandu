/* eranduint.c - erandu random integer Version 1.0.0                   */
...
/* is not validated                                     */
/* See erandupwr.c for generating an unsigned integer   */
/* of 1-32 bits.                                        */
...
int eranduint(rufmt *ru, int limit)
   ...
   num = (double) erandu(ru) / MAXINT;   /* generate random number 0-1 */
